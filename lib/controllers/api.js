...
exports.login = function(req, res) {
  ...
  nfdsdk.connect({host: _config.sdkhost, port: _config.sdkport}, function() {
    nfdsdk.login(creds.email, creds.password, function(user) {
...
exports.updateSystem = function(req, res) {
  ...
  nfdsdk.connect({host: _config.sdkhost, port: _config.sdkport}, function() {
    ...
    nfdsdk.getSystem(systemId, function(existingSystem) {
      ...
      nfdsdk.putSystem(user, JSON.stringify(systemToUpdate), function(result) {
        nfdsdk.quit(function() {
          res.json(result);
        });
      });
...
exports.deleteSystem = function(req, res) {
  ...
  nfdsdk.connect({host: _config.sdkhost, port: _config.sdkport}, function() {
    nfdsdk.deleteSystem(user, systemId, function() {
      nfdsdk.quit(function() {
        res.json({ok:true});
      });
    });
...
exports.addContainer = function(req, res) {
  ...
  nfdsdk.connect({host: _config.sdkhost, port: _config.sdkport}, function() {
    nfdsdk.addContainer(user, systemId, JSON.stringify(container), function(container) {
      nfdsdk.quit(function() {
        res.json(container);
      });
    });
...
exports.updateContainer = function(req, res) {
  ...
  nfdsdk.connect({host: _config.sdkhost, port: _config.sdkport}, function() {
    nfdsdk.putContainer(user, systemId, JSON.stringify(container), function(result) {
      nfdsdk.quit(function() {
        res.json(result);
      });
    });
...
exports.buildContainer = function(req) {
  nfdsdk.connect({host: _config.sdkhost, port: _config.sdkport}, function() {
    ...
    nfdsdk.buildContainer(req.data.user, req.data.systemId, req.data.containerId, function(result) {
      nfdsdk.quit(function() {
        if (result) {
          req.io.emit('result', result);
        }
